...
-- Version : 26.5.0
-- Date    : 20260713
-- Change  : Permit a full binned FIFO to replace its accepted head in the
--           same cycle, avoiding a false readyless-input drop at full level.
-- =======================================
    ...
    begin
        if rising_edge(i_clk) then
            if i_rst = '1' or i_clear = '1' then
                ...
                write_v    := (i_write = '1') and
                              ((to_integer(level_v) < FIFO_DEPTH_CONST) or read_v);
