...
-----------------------------------------------------------
    ...
    gen_scitile_B: if (IS_TILE_B=true) generate
        ...
        -- synthesis read_comments_as_HDL on
        -- lvds_rec_small_A : entity work.ip_altlvds_rx
        -- generic map ( g_CHANNELS => 6, g_DESER_FACTOR => 10 )
        -- port map (
        --     rx_channel_data_align   => rx_align(11) & rx_align(9 downto 8) & rx_align(2 downto 0),
        --     rx_fifo_reset           => rx_fifo_reset(11) & rx_fifo_reset(9 downto 8) & rx_fifo_reset(2 downto 0),
        --     rx_in                   => i_rx(11) & i_rx(9 downto 8) & i_rx(2 downto 0),
        --     rx_inclock              => rx_inclock_A_ctrl,
        --     rx_reset                => rx_reset(11) & rx_reset(9 downto 8) & rx_reset(2 downto 0),
        ...
        -- generic map ( g_CHANNELS => 7, g_DESER_FACTOR => 10 )
        -- port map (
        --     rx_channel_data_align   => rx_align(12) & rx_align(10) & rx_align(7 downto 3),
        --     rx_fifo_reset           => rx_fifo_reset(12) & rx_fifo_reset(10) & rx_fifo_reset(7 downto 3),
        --     rx_in                   => i_rx(12) & i_rx(10) & i_rx(7 downto 3),
        --     rx_inclock              => rx_inclock_B_ctrl,
        --     rx_reset                => rx_reset(12) & rx_reset(10) & rx_reset(7 downto 3),
    ...
    gen_scitile_A: if (IS_TILE_B=false) generate
        ...
        -- synthesis read_comments_as_HDL on
        -- lvds_rec_small_A : entity work.ip_altlvds_rx
        -- generic map ( g_CHANNELS => 8, g_DESER_FACTOR => 10 )
        -- port map (
        --     rx_channel_data_align   => rx_align(12) & rx_align(10) & rx_align(7 downto 2),
        --     rx_fifo_reset           => rx_fifo_reset(12) & rx_fifo_reset(10) & rx_fifo_reset(7 downto 2),
        --     rx_in                   => i_rx(12) & i_rx(10) & i_rx(7 downto 2),
        --     rx_inclock              => rx_inclock_A_ctrl,
        --     rx_reset                => rx_reset(12) & rx_reset(10) & rx_reset(7 downto 2),
        ...
        -- lvds_rec_small_B : entity work.ip_altlvds_rx
        -- generic map ( g_CHANNELS => 5, g_DESER_FACTOR => 10 )
        -- port map (
        --     rx_channel_data_align   => rx_align(11) & rx_align(9 downto 8) & rx_align(1 downto 0),
        --     rx_fifo_reset           => rx_fifo_reset(11) & rx_fifo_reset(9 downto 8) & rx_fifo_reset(1 downto 0),
        --     rx_in                   => i_rx(11) & i_rx(9 downto 8) & i_rx(1 downto 0),
        --     rx_inclock              => rx_inclock_B_ctrl,
        --     rx_reset                => rx_reset(11) & rx_reset(9 downto 8) & rx_reset(1 downto 0),
...
-----------------------------------------------------------
    ...
    gen_channels : for i in g_INPUTS-1 downto 0 generate
        ...
        -- generate receivers, depending if upper or lower connector is used
        gen_scitile_B : if (IS_TILE_B=true) generate

            gen_a_part : if ( i = 11 or i = 9 or i = 8 or i = 2 or i = 1 or i = 0 ) generate
            ...
            gen_b_part : if ( i = 12 or i = 10 or i = 7 or i = 6 or i = 5 or i = 4 or i = 3 ) generate
