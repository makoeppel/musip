...
begin
    ...
    port map (
        i_fpga_ID               => (5 => '1', others => '0'), -- will be set by 15 jumpers in the end, set this to something random for now
        i_FEB_type              => "111010", -- Type of the frontendboard (111010: mupix, 111000: mutrig, DO NOT USE 000111 or 000000 HERE !!!!)
        ...
        i_override_data         => override_data_in, -- data input for states link_test and sync_test;
        i_override_datak        => override_data_is_k_in,
        i_override_req          => override_req,
        o_override_granted      => override_granted,
        i_data_priority         => '0',
        leds                    => open, -- debug
    ...
    port map (
        ...
        state_reset => state_reset,
        state_out_of_DAQ => state_out_of_DAQ,
        i_fpga_addr => (others => '0'),
        o_run_number => runnumber,
        o_reset_mask => open,
