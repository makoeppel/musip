...
force -freeze mupix_ctrl_tb/reg_wdata "x00000001"
run 8ns
force -freeze mupix_ctrl_tb/reg_addr [examine mupix_registers/MP_CTRL_DIRECT_SPI_CHIP_M_LOW_REGISTER_W]
force -freeze mupix_ctrl_tb/reg_wdata "0xFFFFFFFF"
run 8ns
force -freeze mupix_ctrl_tb/reg_addr [examine mupix_registers/MP_CTRL_DIRECT_SPI_CHIP_M_HIGH_REGISTER_W]
force -freeze mupix_ctrl_tb/reg_wdata "0xFFFFFFFF"
run 8ns
force -freeze mupix_ctrl_tb/reg_we 0
run 800ns
force -freeze mupix_ctrl_tb/reg_we 1
force -freeze mupix_ctrl_tb/reg_addr [examine mupix_registers/MP_CTRL_DIRECT_SPI_START_REGISTER_W]
force -freeze mupix_ctrl_tb/reg_wdata "0"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x49248000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x00000000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x24924000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x00000000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x80000000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "xC9248000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x80000000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "xa4924000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x80000000"
run 8ns
force -freeze mupix_ctrl_tb/reg_wdata "x00000000"
