# `report/signoff/cases/<CASE_ID>.md` — per-case evidence template
...
| toggle | pending | 80.0 | |
| functional | pending | bucket-dependent | linkage to [`../../../doc/DV_CROSS.md`](../../../doc/DV_CROSS.md) cross cluster |
...
- Planning row for this case: [`../../../doc/DV_<BUCKET>.md`](../../../doc/DV_BASIC.md)
- Bucket ordered-merge row for this case: [`../buckets/<BUCKET>.md`](../buckets/BASIC.md)
- Bug ledger (if this case anchors a BUG entry): [`../../../doc/BUG_HISTORY.md`](../../../doc/BUG_HISTORY.md)
...
- Stimulus field map anchor: [`../../../doc/DV_BASIC.md#stimulus-field-map-per-frame-per-lane`](../../../doc/DV_BASIC.md#stimulus-field-map-per-frame-per-lane)
