# `report/signoff/txn_growth/` — ⚠️ pending checkpoint UCDBs
...
- **scope:** every random / soak case under [`../../../doc/DV_PROF.md`](../../../doc/DV_PROF.md) whose `observed_txn > 1`.

## What this page will contain once the emitter is wired

One file per random / soak case, named `report/signoff/txn_growth/<case_id>.md`. Each file will carry a real table:
...
- [`../../../doc/DV_PROF.md`](../../../doc/DV_PROF.md) — planned random / soak catalog
- [`../../../doc/DV_REPORT.md`](../../../doc/DV_REPORT.md) — top-level dashboard
- [`../../../doc/DV_REPORT.json`](../../../doc/DV_REPORT.json) — machine-readable source (will carry `random_cases[].txn_growth_curve` once wired)
