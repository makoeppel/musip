# `report/signoff/buckets/PROF.md` — ordered-merge trace

> **Audience:** chief architect. This page is the per-bucket audit trail required by `~/.codex/skills/dv-workflow/SKILL.md` §Coverage rule 9. Every row below is one case, in the canonical case-id order declared in [`../../../doc/DV_PROF.md`](../../../doc/DV_PROF.md). Rows follow the skill's strict column contract. This file is generated — hand edits are overwritten.

- **bucket:** `PROF` — [`../../../doc/DV_PROF.md`](../../../doc/DV_PROF.md)
