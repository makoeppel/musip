...
- **status:** ❓ pending — no CROSS run has produced merged-UCDB evidence yet. Per-run detail pages live under [`../cross/`](../cross/) as placeholders. See [`../../../doc/DV_REPORT.md`](../../../doc/DV_REPORT.md) §Remaining work.
...
- Run-id ordering matches the canonical `§6.1..§6.9` cluster layout in [`../../../doc/DV_CROSS.md`](../../../doc/DV_CROSS.md).
...
- Bug regression anchors touching this bucket: [`../../../doc/BUG_HISTORY.md`](../../../doc/BUG_HISTORY.md).
