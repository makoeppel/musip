...
OPQ_N_SHD ?= 128
OPQ_N_HIT ?= 2047
OPQ_LANE_FIFO_DEPTH ?= 8192
OPQ_TICKET_FIFO_DEPTH ?= 8192
OPQ_HANDLE_FIFO_DEPTH ?= 64
OPQ_PAGE_RAM_DEPTH ?= 65536
OPQ_DEBUG_LEVEL ?= 2
OPQ_DEBUG_BYPASS_SUBFRAME_HIT_LIMIT ?= 0
...
OPQ_DUT_DEFINES = \
	...
	+define+OPQ_DEBUG_LEVEL=$(OPQ_DEBUG_LEVEL) \
	$(if $(filter 1,$(OPQ_DEBUG_BYPASS_SUBFRAME_HIT_LIMIT)),+define+OPQ_DEBUG_BYPASS_SUBFRAME_HIT_LIMIT)
