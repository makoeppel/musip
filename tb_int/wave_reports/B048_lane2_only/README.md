# `B048_lane2_only` wave bundle

- **profile:** `B048_lane2_only`
- **same-axis VCD:** `sim/B048_lane2_only.vcd`
...
`python3 external/mu3e-ip-cores/tools/packet_transaction_traffic_analyzer/scripts/serve_packet_analyzer.py --dir tb_int/wave_reports/B048_lane2_only/packet_analyzer --port 8765`
