# `B049_lane3_only` wave bundle

- **profile:** `B049_lane3_only`
- **same-axis VCD:** `sim/B049_lane3_only.vcd`
...
`python3 external/mu3e-ip-cores/tools/packet_transaction_traffic_analyzer/scripts/serve_packet_analyzer.py --dir tb_int/wave_reports/B049_lane3_only/packet_analyzer --port 8765`
