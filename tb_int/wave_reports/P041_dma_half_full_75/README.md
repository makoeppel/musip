# `P041_dma_half_full_75` wave bundle

- **profile:** `P041_dma_half_full_75`
- **same-axis VCD:** `sim/P041_dma_half_full_75.vcd`
...
`python3 external/mu3e-ip-cores/tools/packet_transaction_traffic_analyzer/scripts/serve_packet_analyzer.py --dir tb_int/wave_reports/P041_dma_half_full_75/packet_analyzer --port 8765`
