/********************************************************************\
  ...
  Contents:     Midas Slowcontrol Frontend to handle a LakeShore34
...
const char *frontend_name = "LS340 SC";
...
DEVICE_DRIVER oven_driver[] = {
  { "LS340", ls340_in,       15, tcpip_rs232, DF_INPUT  },
  { "LS340", ls340_out,       8, tcpip_rs232, DF_OUTPUT },
  { "" }
};
...
EQUIPMENT equipment[] = {
  ...
  { "LS340",              // equipment name
   {81, 0,                // event ID, trigger mask
    "SYSTEM",             // event buffer
