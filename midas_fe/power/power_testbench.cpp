...
INT frontend_init()
{
    ...
    /*mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 26, "Enable channel 1", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 27, "Enable channel 2", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 28, "Enable channel 3", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 30, "Enable channel 4", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 34, "Enable channel 5", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 35, "Enable channel 6", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 36, "Enable channel 7", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 37, "Enable channel 8", 0.1, 1.0, 0.0);

    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 25, "Reset ch1-4", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Output",  mscb_driver, "mscb401.psi.ch", 65535, 33, "Reset ch5-8", 0.1, 1.0, 0.0);

    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 1, "OC ch1", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 2, "OC ch2", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 3, "OC ch3", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 4, "OC ch4", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 9, "OC ch5", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 10, "OC ch6", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 11, "OC ch7", 0.1, 1.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 12, "OC ch8", 0.1, 1.0, 0.0);

    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 17, "Current ch1", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 18, "Current ch2", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 19, "Current ch3", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 20, "Current ch4", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 42, "Current ch5", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 43, "Current ch6", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 44, "Current ch7", 0.01, 5.0, 0.0);
    mscb_define("PowerDistribution", "Input",  mscb_driver, "mscb401.psi.ch", 65535, 45, "Current ch8", 0.01, 5.0, 0.0);*/
    ...
    for(unsigned int eqID = 0; eqID<nEq-1; eqID++)
    {
        ...
        else if( std::find( hameg_names.begin(), hameg_names.end(), shortname ) != hameg_names.end() )
        {
            if ( driver_name == "HMP4040")
                ...
                std::cout << "Driver name " << driver_settings["DriverName"] << " not recognized. Set to default = HMP4040\n";
                drivers.emplace_back(new HMP4040Driver(equipment[eqID].name,&equipment[eqID].info));
            }
        }
        else if( std::find( keithley_names.begin(), keithley_names.end(), shortname ) != keithley_names.end() )
        {
            if ( driver_name == "Keithley2450")
                ...
                drivers.emplace_back(new Keithley2400Driver(equipment[eqID].name,&equipment[eqID].info));
                ...
                drivers.emplace_back(new Keithley6487Driver(equipment[eqID].name,&equipment[eqID].info));
            else {
                std::cout << "Driver name " << driver_settings["DriverName"] << " not recognized. Set to default = Keithley2611B\n";
                drivers.emplace_back(new Keithley2611BDriver(equipment[eqID].name,&equipment[eqID].info));
            }
        }
