/********************************************************************\
  ...
  Contents:     Midas frontend to readout the Sep61 and PS64 vacuum control unit
...
const char *frontend_name = "PUMP_SC";
...
//! device driver list
DEVICE_DRIVER pump_driver[] = {
  { "pump_in",  pump_in,  PUMP_IN_VARS,   sps_tcpip, DF_INPUT  },
  { "pump_out", pump_out, PUMP_OUT_VARS,  sps_tcpip, DF_OUTPUT  },
  { "" }
};
...
EQUIPMENT equipment[] = {
  ...
  { "Pump",               // equipment name
   {79, 0,                // event ID, trigger mask
    ...
    pump_driver,          // device driver list
    NULL,                 // init string
  },
