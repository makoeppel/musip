...
DummyFEBSlowcontrolInterface::DummyFEBSlowcontrolInterface(mudaq::MudaqDevice &mdev):
    ...
    scregs(8, vector<uint32_t>(pow(2,16), 0))
{
...
int DummyFEBSlowcontrolInterface::FEB_write(uint32_t febIDx, const uint32_t startaddr, const vector<uint32_t> & data, const bool nonincrementing, const bool broadcast, const uint32_t MSTR_bar [[maybe_unused]])
{
    ...
    auto status = FEBSlowcontrolInterface::FEB_write(febIDx, startaddr, data, nonincrementing, broadcast, MSTR_bar);
...
int DummyFEBSlowcontrolInterface::FEB_read(uint32_t febIDx, const uint32_t startaddr, vector<uint32_t> & data, const bool nonincrementing)
{
...
int DummyFEBSlowcontrolInterface::FEBsc_NiosRPC(uint32_t febIDx [[maybe_unused]], uint16_t command [[maybe_unused]], vector<vector<uint32_t> > payload_chunks [[maybe_unused]])
{
